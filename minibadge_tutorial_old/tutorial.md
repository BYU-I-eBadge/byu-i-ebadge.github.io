...
![minibadge GitHub page](../imgs/minibadge_tutorial_old/github_page.png)
...
![minibadge release](../imgs/minibadge_tutorial_old/releases_page.png)
...
![hint make new project](../imgs/minibadge_tutorial_old/open_project.png)
...
![go to preferences](../imgs/minibadge_tutorial_old/preferences.png)

Then, go to `Manage Symbol Libraries`.

![go to manage symbol libraries](../imgs/minibadge_tutorial_old/manage_symbols_highlighted.png)

A new window will appear. Navigate to the `Project Specific Libraries` tab to add the Minibadge symbol to this project only.

![switch tabs](../imgs/minibadge_tutorial_old/sym_switch_tabs.png)
...
![add symbol library button](../imgs/minibadge_tutorial_old/add_sym_library.png)
![point out symbol libraries are files](../imgs/minibadge_tutorial_old/sym_is_file.png)
...
![go to manage footprint libraries](../imgs/minibadge_tutorial_old/manage_footprint_highlighted.png)
...
![add footprint library button](../imgs/minibadge_tutorial_old/add_footprint_lib.png)
![point out footprint libraries are folders](../imgs/minibadge_tutorial_old/footprint_is_directory.png)

### Schematic

Enter the schematic editor by pressing the icon in the main window.

![hint enter schematic editor](../imgs/minibadge_tutorial_old/enter_schematic_editor.png)
...
![select symbol window minibadge example](../imgs/minibadge_tutorial_old/select_symbol.png)
...
![symbol on schematic](../imgs/minibadge_tutorial_old/place_in_schematic.png)
...
![add additional symbols](../imgs/minibadge_tutorial_old/place_more_symbols.png)
...
![add wire](../imgs/minibadge_tutorial_old/select_wire.png)
...
![add power symbols](../imgs/minibadge_tutorial_old/select_power.png)
...
![select ground symbol window](../imgs/minibadge_tutorial_old/select_gnd_symbol.png)

Similarly, power symbols should be placed for 3.3V. These should go on the pins labelled `3V3+` and `+3V3`.

![select 3.3V symbol window](../imgs/minibadge_tutorial_old/select_3V3_symbol.png)
...
![select no connect flags](../imgs/minibadge_tutorial_old/select_no_connect_flags.png)

Annotate the schematic so that the design can be checked for errors and be imported to the PCB editor.

![select annotate schematic](../imgs/minibadge_tutorial_old/select_annotate_schem.png)
...
![annotate window](../imgs/minibadge_tutorial_old/annotate_dialog.png)

Now that the schematic is fully annotated, the Electrical Rules Checker (ERC) should now be run.

![select ERC](../imgs/minibadge_tutorial_old/select_electrical_rules_checker.png)

Click `Run ERC` on the window that appears.

![run ERC](../imgs/minibadge_tutorial_old/erc_dialog_run.png)
...
![ERC false errors](../imgs/minibadge_tutorial_old/note_on_false_erc_errors.png)
...
![used footprints](../imgs/minibadge_tutorial_old/used_example_footprints.png)
...
![select PCB editor](../imgs/minibadge_tutorial_old/enter_pcb_editor.png)

A blank PCB design will appear. Click the icon to update the PCB from the schematic or use the keyboard shortcut (F8).

![select update PCB from schematic](../imgs/minibadge_tutorial_old/initial_pcb_update_from_schem.png)

A window will appear. Use the defaults and click `Update PCB`.

![update PCB window](../imgs/minibadge_tutorial_old/update_pcb_dialog.png)

Components will appear on the PCB editor. Close the window an click near the center to place the mess of footprints.

![see added footprints to place](../imgs/minibadge_tutorial_old/see_added_footprints.png)
...
![flip components hint](../imgs/minibadge_tutorial_old/flip_components.png)

After arranging components, the design should appear similar to this:

![example footprint placement](../imgs/minibadge_tutorial_old/after_footprint_placement.png)
...
![select draw rule area](../imgs/minibadge_tutorial_old/select_rule_area.png)
...
![select draw filled zones](../imgs/minibadge_tutorial_old/select_draw_filled_zones.png)
...
![ground plane properties window](../imgs/minibadge_tutorial_old/ground_plane_properties.png)
...
![power plane properties window](../imgs/minibadge_tutorial_old/power_plane_properties.png)
...
![select route track](../imgs/minibadge_tutorial_old/select_route_traces.png)
...
![draw track hint](../imgs/minibadge_tutorial_old/draw_track.png)

Make sure to refill the zones so that the track is isolated from either plane.
Press `B` to refill all copper zones.

![refill zone hint](../imgs/minibadge_tutorial_old/refill_zone.png)
...
![select image converter](../imgs/minibadge_tutorial_old/select_image_converter.png)

A new window will open.
Select `Load Source Image` and navigate to the image that will be placed on the PCB silkscreen.

![select load image source](../imgs/minibadge_tutorial_old/select_load_source_image.png)
...
![get dimensions of window hint](../imgs/minibadge_tutorial_old/get_dimensions_of_window.png)
...
![export image window](../imgs/minibadge_tutorial_old/export_image_to_silk.png)
...
![delete ref designator for vanity image](../imgs/minibadge_tutorial_old/delete_ref_for_decor.png)
...
![select rectangle properties](../imgs/minibadge_tutorial_old/rectangle_properties.png)

In the properties, make the rectangle a filled shape.
Double check the layer is correct.

![rectangle properties front window](../imgs/minibadge_tutorial_old/rectangle_properties_fill_shape.png)
...
![rectangle properties back window](../imgs/minibadge_tutorial_old/repeat_mask_delete_rear.png)

Verify the design using the Design Rules Checker (DRC).
Click on the DRC icon.

![select DRC](../imgs/minibadge_tutorial_old/select_drc.png)

A new window will appear.
Select `Run DRC`.

![DRC window](../imgs/minibadge_tutorial_old/drc_dialog.png)
...
![select gerber output](../imgs/minibadge_tutorial_old/select_gerber_output.png)
...
![gerber plot window](../imgs/minibadge_tutorial_old/plot_dialog.png)
...
![generate drill window](../imgs/minibadge_tutorial_old/gen_drill_dialog.png)
...
![open directory shortcut](../imgs/minibadge_tutorial_old/plot_open_dir.png)
...
![zip output files](../imgs/minibadge_tutorial_old/zip_output_files.png)
...
![preview JLCPCB](../imgs/minibadge_tutorial_old/post_upload_jlcpcb.png)
